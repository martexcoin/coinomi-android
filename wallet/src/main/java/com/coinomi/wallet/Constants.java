...
import com.coinomi.core.coins.MartexcoinMain;
...
public class Constants {
    ...
    public static final String SUPPORT_EMAIL = "support@martexcoin.org; suporte@martexcoin.org";
...
*/
            new CoinAddress(MartexcoinMain.get(),   new ServerAddress("electrum.martexcoin.org", 50001),
                                                    new ServerAddress("electrum1.martexcoin.org", 50001))
    );
...
//        COINS_ICONS.put(CoinID.URO_MAIN.getCoinType(), R.drawable.uro);
        ...
        */
        COINS_ICONS.put(CoinID.MARTEXCOIN_MAIN.getCoinType(), R.mipmap.martexcoin);
...
//        COINS_BLOCK_EXPLORERS.put(CoinID.URO_MAIN.getCoinType(), "https://chainz.cryptoid.info/uro/tx.dws?%s");
        ...
        */
        COINS_BLOCK_EXPLORERS.put(CoinID.MARTEXCOIN_MAIN.getCoinType(), "https://be.martexcoin.org/tx/%s");
    }

    public static final CoinType DEFAULT_COIN = MartexcoinMain.get();
    public static final List<CoinType> DEFAULT_COINS = ImmutableList.of((CoinType) MartexcoinMain.get());
