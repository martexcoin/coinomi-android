    ...
    public Cursor query(final Uri uri, final String[] projection, final String selection,
        ...
        if (!offline && (lastUpdated == 0 || now - lastUpdated > Constants.RATE_UPDATE_FREQ_MS)) {
            ...
            try {
                ...
                //url = new URL("https://braziliex.com/api/v1/public/ticker/mxt_brl");
            ...
            if (response.isSuccessful()) {
                ...
                for (JSONObject obj : objs) {
                    ...
                    while (it.hasNext()) {
                        ...
                        returnJsonObject.put(key, obj.get(key));
                    }
                }
        ...
        try {
            ...
            if (response.isSuccessful()) {
                log.info("fetched exchange Braziliex rates from {}, took {} ms", url,
                        System.currentTimeMillis() - start);
                return new JSONObject(response.body().string().replace("last", "MXT"));
            } else {
